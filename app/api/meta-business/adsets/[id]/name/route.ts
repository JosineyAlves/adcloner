...
export async function POST(
  ...
  try {
    ...
    console.log(`🔄 Atualizando nome do conjunto ${adSetId}:`, { name: trimmedName })
    ...
    console.log(`✅ Nome do conjunto ${adSetId} atualizado com sucesso`)
    ...
    console.error('Error updating adset name:', error)
    return NextResponse.json({
