...
export async function PUT(request: NextRequest) {
  try {
    ...
    // Chamada para Facebook Marketing API para atualizar orçamento da campanha
    // Para campanhas, o orçamento é definido no nível do ad set, mas podemos atualizar
    // o daily_budget ou lifetime_budget dependendo do tipo de orçamento
    ...
    if (!facebookResponse.ok) {
      ...
      return NextResponse.json(
        { error: 'Failed to update campaign budget', details: errorData },
